...
OptionPricingVR: Main04.o GmtrAsianCall.o EurCall.o MCModel.o PathDepOption.o
	$(CC) $(CFLAGS) -o OptionPricingVR Main04.o GmtrAsianCall.o EurCall.o MCModel.o PathDepOption.o
